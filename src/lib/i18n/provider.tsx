...
const DICT: Record<Locale, Dict> = {
  en: {
    ...
    svcForm: {
      ...
      optionsTitle: 'Packages', addOption: 'Add package', optionName: 'e.g. Premium, Gold', priceDelta: 'Package price (full)',
      extrasTitle: 'Add-ons', addExtra: 'Add add-on', extraName: 'e.g. Private guide, Extra night', priceCol: 'Price',
      optionsHint: 'The customer buys ONE package. The Base price above is the default package; each package here has its OWN full price (it replaces the base when chosen). Package price × people for per-person services.',
      extrasHint: 'Optional paid add-ons; the customer chooses how many of each (− / + counter). Flat price, never × people.',
      ...
      breakdown: 'Price breakdown', basePrice: 'Base package', exampleTotal: 'Example (Base package + all add-ons)',
      variantsLabel: 'Packages (customer picks one)', addonsLabel: 'Add-ons (× counter)',
  ...
  fr: {
    ...
    svcForm: {
      ...
      optionsTitle: 'Formules', addOption: 'Ajouter une formule', optionName: 'ex. Premium, Gold', priceDelta: 'Prix de la formule (complet)',
      extrasTitle: 'Suppléments', addExtra: 'Ajouter un supplément', extraName: 'ex. Guide privé, Nuit supplémentaire', priceCol: 'Prix',
      optionsHint: 'Le client achète UNE formule. Le prix de base ci-dessus est la formule par défaut ; chaque formule ici a son PROPRE prix complet (qui remplace la base si choisie). Prix de la formule × personnes pour les services par personne.',
      extrasHint: 'Suppléments payants facultatifs ; le client choisit la quantité de chacun (compteur − / +). Prix fixe, jamais × personnes.',
      ...
      breakdown: 'Détail du prix', basePrice: 'Formule de base', exampleTotal: 'Exemple (Formule de base + tous les suppléments)',
      variantsLabel: 'Formules (le client en choisit une)', addonsLabel: 'Suppléments (× compteur)',
